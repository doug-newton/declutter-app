...
import { AddFamilyData, AddFamilyResult, Family, FamilyMember } from '../models';
...
export class FamilyService {
  ...
  family$: Observable<Family> = this.familySubject$.pipe(filter(family => family != null))
  numMembers$ = this.family$.pipe(map(family => {
